...
public class BilkentNavigation extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pointCreator();
        setContentView(R.layout.activity_bilkent_navigation);
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                BilkentNavigation.this.adapter.getFilter().filter(cs);
        ...
        tool.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PopupMenu popup = new PopupMenu(BilkentNavigation.this, tool);
            ...
            for (int i = 0; i < points.size(); i++) {
                for (int j = 0; j < points.get(i).getName().size(); j++) {
                    ...
                    if ((points.get(i).getName().get(j)).equals(location)) {
                        mMap.clear();
                        destination = (new MarkerOptions().position(points.get(i).getCoordinate()).title("Destination"+location));
